...
Route::group(['middleware' => ['auth:api', 'token.type:authToken']], function(){
    ...
    Route::group(['prefix' => 'user', 'middleware' => ['user.maintenance']], function(){
        ...
        Route::post('/get-user-uploader', [
            'uses' => 'API\UserController@getUserUploader',
            'as' => 'user.uploader',
        ]);
    ...
    //Permissions
    Route::group(['prefix' => 'permission', 'middleware' => ['permission.maintenance']], function(){
        Route::get('/index', [
    ...
    // Branch Routes
    Route::group(['prefix' => 'branch', 'middleware' => ['branch.maintenance']], function () {
        Route::get('/index', [
    ...
    // Company Routes
    Route::group(['prefix' => 'company', 'middleware' => ['company.maintenance']], function () {
        Route::get('/index', [
    ...
    // Position Routes
    Route::group(['prefix' => 'position', 'middleware' => ['position.maintenance']], function () {
        Route::get('/index', [
    ...
    // Department Routes
    Route::group(['prefix' => 'department', 'middleware' => ['department.maintenance']], function () {
        Route::get('/index', [
    ...
    // Division Routes
    Route::group(['prefix' => 'division', 'middleware' => ['division.maintenance']], function () {
        Route::get('/index', [
    ...
    Route::group(['prefix' => 'file-manager', 'middleware' => ['file.manager.maintenance']], function () {
        Route::get('/index', [
    ...
    //Activity Logs
    Route::group(['prefix' => 'activity_logs', 'middleware' => ['activity.logs']], function(){
        Route::get('/index', [
